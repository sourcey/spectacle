---
title: Roadmap
description: What Sourcey has shipped and what is still planned.
---
...
- i18n
- an API playground
- a VS Code extension and publishable theme packages

For the full running detail, keep `ROADMAP.md` as the source of truth in the repo root.
